...
//import LoginScreen.Entry; 

public class LoginScreen implements MinuetoKeyboardHandler, MinuetoMouseHandler {
		...
		if (button == 1)
        {
    		...
    		{	
    			...
    			try {
    				...
    				URL url = new URL("http://172.28.9.138:4242/oauth/token?grant_type=password&username=" + login + "&password=" + real_pass);
